...
fun main() {
    ...
    println(
        "Груз с весом $firstCargoWeight кг и объемом $firstCargoValue л соответствует категории '$AVERAGE_CATEGORY': " + "${
            (firstCargoWeight > AVERAGE_CATEGORY_WEIGHT_FROM) &&
                    (firstCargoWeight <= AVERAGE_CATEGORY_WEIGHT_TO) &&
            ...
            (secondCargoWeight > AVERAGE_CATEGORY_WEIGHT_FROM) &&
                    (secondCargoWeight <= AVERAGE_CATEGORY_WEIGHT_TO) &&
